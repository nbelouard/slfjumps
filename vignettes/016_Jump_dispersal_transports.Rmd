...
for (i in 1:10000){
  ...
  ModelsRail <- rbind(ModelsRail, 
                      c(summary_modRailac$coefficients[c(1:4, 13:16)], 
  ...
  ModelsRoad <- rbind(ModelsRoad, 
                      c(summary_modRoadac$coefficients[c(1:4, 13:16)], 
  ...
  ModelsInt <- rbind(ModelsInt, 
                     c(summary_modIntac$coefficients[c(1:4, 13:16)],
...
names(ModelsRail) = c("Int_est", "DJ_est", "DN_est", "AC_est",
                      "Intp", "DJp", "DNp", "ACp", "Rsquared", "Adj Rsquared")
...
for (i in 1:10000){
  ...
  summary_modIntac <- summary(modInt_ac)
  ModelsInt <- rbind(ModelsInt, 
                     c(summary_modIntac$coefficients[c(1:4, 13:16)], summary_modIntac$r.squared, summary_modIntac$adj.r.squared)) 
  #estimates: intercept, diffusers-jumpers, diffusers-negatives, autocorrelation coef; p-values: diffusers-jumpers, diffusers-negatives, autocorrelation coef

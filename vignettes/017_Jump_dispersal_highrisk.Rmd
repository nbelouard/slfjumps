...
st_write(mail_buffer, file.path(here(), "figures", "GIS", "landscape", "mail_buffer.shp"), append = F)
dim(mail_buffer) #86
st_crs(mail_buffer)
...
st_write(wood_buffer, file.path(here(), "figures", "GIS", "landscape", "wood_buffer.shp"), append = F)
...
st_write(wineries_buffer, file.path(here(), "figures", "GIS", "landscape", "wineries_buffer.shp"), append = F)
dim(wineries)
...
st_write(people_buffer, file.path(here(), "figures", "GIS", "landscape", "people_buffer.shp"), append = F)
dim(people)
...
st_write(garages_buffer, file.path(here(), "figures", "GIS", "landscape", "garages_buffer.shp"), append = F)
dim(garages)
st_crs(garages)
...
st_write(boats_buffer, file.path(here(), "figures", "GIS", "landscape", "boats_buffer.shp"), append = F)
dim(boats)
...
# Calculate mean and median for full dataset
slf_obsmeans_full <- slfPA_uptodate_long %>%
  filter(Category_full == "Negatives") %>% 
  group_by(Category_full, DistanceType) %>% 
  summarise(MeanDistance = mean(DistanceValue),
            MedianDistance = median(DistanceValue))
...
# Calculate mean and median for rarefied dataset
slf_obsmeans_rarefied <- slfPA_uptodate_long %>%
  filter(Category_rare == "Diffusers") %>% 
  group_by(Category_rare, DistanceType) %>% 
  summarise(MeanDistance = mean(DistanceValue),
            MedianDistance = median(DistanceValue))
...
# 8. Difference with diffusers and negatives
## Full dataset
...
for (i in 1:10000){
  ...
  ## 1. Model for airports distance:
  # Calculate ac coefficients
  ac_airports <- autocov_dist(dataset$DistToAirports, coords, nbs = 500, type = "inverse", longlat = T)
  if (dim(dataset)[1] != length(ac_airports)){ print("Error AC rail")}
  dataset %<>% add_column(ac_airports = ac_airports)
  # Run model
  modAirports_ac <- lm(log(DistToAirports+1) ~ Category_full + ac_airports, data = dataset)
  # plotresid(modRail_ac)
  summary_modAirportsac <- summary(modAirports_ac)
  ModelsAirports <- rbind(ModelsAirports, 
                      c(summary_modAirportsac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
                      summary_modAirportsac$r.squared, 
                      summary_modAirportsac$adj.r.squared)) #estimates: intercept, diffusers-jumpers, diffusers-negatives, autocorrelation coef; p-values: diffusers-jumpers, diffusers-negatives, autocorrelation coef
  
  
  
  ## 2. Model for cars distance:
  # Calculate ac coefficients
  ac_garages <- autocov_dist(dataset$DistToGarages, coords, nbs = 500, type = "inverse", longlat = T)
  if (dim(dataset)[1] != length(ac_garages)){ print("Error AC garages")}
  dataset %<>% add_column(ac_garages = ac_garages)
  # Run model
  modGarages_ac <- lm(log(DistToGarages+1) ~ Category_full + ac_garages, data = dataset)
  # plotresid(modRail_ac)
  summary_modGaragesac <- summary(modGarages_ac)
  ModelsGarages <- rbind(ModelsGarages, 
                      c(summary_modGaragesac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
                      summary_modGaragesac$r.squared, 
                      summary_modGaragesac$adj.r.squared)) #estimates: intercept, diffusers-jumpers, diffusers-negatives, autocorrelation coef; p-values: diffusers-jumpers, diffusers-negatives, autocorrelation coef
  
  
  
    ## 3. Model for mail/package carriers:
  # Calculate ac coefficients
  ac_mail <- autocov_dist(dataset$DistToMail, coords, nbs = 500, type = "inverse", longlat = T)
  if (dim(dataset)[1] != length(ac_mail)){ print("Error AC mail")}
  dataset %<>% add_column(ac_mail = ac_mail)
  # Run model
  modMail_ac <- lm(log(DistToMail+1) ~ Category_full + ac_mail, data = dataset)
  # plotresid(modRail_ac)
  summary_modMailac <- summary(modMail_ac)
  ModelsMail <- rbind(ModelsMail, 
                     c(summary_modMailac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
                       summary_modMailac$r.squared, 
                       summary_modMailac$adj.r.squared))
  ...
  ## 4. Model for natural products industry = wood related activities:
  # Calculate ac coefficients
  ac_wood <- autocov_dist(dataset$DistToWood, coords, nbs = 500, type = "inverse", longlat = T)
  if (dim(dataset)[1] != length(ac_wood)){ print("Error AC wood")}
  dataset %<>% add_column(ac_wood = ac_wood)
  # Run model
  modWood_ac <- lm(log(DistToWood+1) ~ Category_full + ac_wood, data = dataset)
  # plotresid(modRail_ac)
  summary_modWoodac <- summary(modWood_ac)
  ModelsWood <- rbind(ModelsWood, 
                     c(summary_modWoodac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
                       summary_modWoodac$r.squared, 
                       summary_modWoodac$adj.r.squared))
  #estimates: intercept, diffusers-jumpers, diffusers-negatives, autocorrelation coef; p-values: diffusers-jumpers, diffusers-negatives, autocorrelation coef
  ...
  # Calculate ac coefficients
  ac_wineries <- autocov_dist(dataset$DistToWineries, coords, nbs = 500, type = "inverse", longlat = T)
  if (dim(dataset)[1] != length(ac_wineries)){ print("Error AC wineries")}
  dataset %<>% add_column(ac_wineries = ac_wineries)
  # Run model
  modWineries_ac <- lm(log(DistToWineries+1) ~ Category_full + ac_wineries, data = dataset)
  # plotresid(modRail_ac)
  summary_modWineriesac <- summary(modWineries_ac)
  ModelsWineries <- rbind(ModelsWineries, 
                     c(summary_modWineriesac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
                       summary_modWineriesac$r.squared, 
                       summary_modWineriesac$adj.r.squared))
  #estimates: intercept, diffusers-jumpers, diffusers-negatives, autocorrelation coef; p-values: diffusers-jumpers, diffusers-negatives, autocorrelation coef
  
  
  ## 6. Model for popular gathering sites = hobbies:
  # Calculate ac coefficients
  ac_hobbies <- autocov_dist(dataset$DistToHobbies, coords, nbs = 500, type = "inverse", longlat = T)
  if (dim(dataset)[1] != length(ac_hobbies)){ print("Error AC hobbies")}
  dataset %<>% add_column(ac_hobbies = ac_hobbies)
  # Run model
  modHobbies_ac <- lm(log(DistToHobbies+1) ~ Category_full + ac_hobbies, data = dataset)
  # plotresid(modRail_ac)
  summary_modHobbiesac <- summary(modHobbies_ac)
  ModelsHobbies <- rbind(ModelsHobbies, 
                     c(summary_modHobbiesac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
                       summary_modHobbiesac$r.squared, 
                       summary_modHobbiesac$adj.r.squared))
  #estimates: intercept, diffusers-jumpers, diffusers-negatives, autocorrelation coef; p-values: diffusers-jumpers, diffusers-negatives, autocorrelation coef
...
names(ModelsAirports) = c("Int_est", "DJ_est", "DN_est", 
                      "AC_est",
                      "Intp", "DJp", "DNp", 
                      "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsAirports, file.path(here(), "tables", "ModelsAirports_full.csv"), row.names = F)


ModelsGarages <- data.frame(ModelsGarages)
names(ModelsGarages) = c("Int_est", "DJ_est", "DN_est", 
                      "AC_est",
                      "Intp", "DJp", "DNp", 
                      "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsGarages, file.path(here(), "tables", "ModelsGarages_full.csv"), row.names = F)


ModelsMail <- data.frame(ModelsMail)
names(ModelsMail) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsMail, file.path(here(), "tables", "ModelsMail_full.csv"), row.names = F)


ModelsWood <- data.frame(ModelsWood)
names(ModelsWood) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsWood, file.path(here(), "tables", "ModelsWood_full.csv"), row.names = F)


ModelsWineries<- data.frame(ModelsWineries)
names(ModelsWineries) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsWineries, file.path(here(), "tables", "ModelsWineries_full.csv"), row.names = F)


ModelsHobbies <- data.frame(ModelsHobbies)
names(ModelsHobbies) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsHobbies, file.path(here(), "tables", "ModelsHobbies_full.csv"), row.names = F)
...
ModelsAirports <- read.csv(file.path(here(), "tables",  "ModelsAirports_full.csv"))
...
ModelsGarages <- read.csv(file.path(here(), "tables",  "ModelsGarages_full.csv"))
...
ModelsMail <- read.csv(file.path(here(), "tables",  "ModelsMail_full.csv"))
...
ModelsWood <- read.csv(file.path(here(), "tables",  "ModelsWood_full.csv"))
...
ModelsWineries <- read.csv(file.path(here(), "tables",  "ModelsWineries_full.csv"))
...
ModelsHobbies <- read.csv(file.path(here(), "tables",  "ModelsHobbies_full.csv"))

ModelsHobbies %>% mutate(DJsignif = ifelse(DJp > 0.05, "NS", "S"),
                  DNsignif = ifelse(DNp > 0.05, "NS", "S"),
                  ACsignif = ifelse(ACp > 0.05, "NS", "S")) %>% 
  count(DJsignif)
#DJ: S = 2178 --> no
...
for (i in 1:10000){
  ...
  dataset %<>% add_column(ac_airports = ac_airports)
  # Run model
  modAirports_ac <- lm(log(DistToAirports+1) ~ Category_rare + ac_airports, data = dataset)
  # plotresid(modRail_ac)
  summary_modAirportsac <- summary(modAirports_ac)
  ModelsAirports <- rbind(ModelsAirports, 
                      c(summary_modAirportsac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
  ...
  dataset %<>% add_column(ac_garages = ac_garages)
  # Run model
  modGarages_ac <- lm(log(DistToGarages+1) ~ Category_rare + ac_garages, data = dataset)
  # plotresid(modRail_ac)
  summary_modGaragesac <- summary(modGarages_ac)
  ModelsGarages <- rbind(ModelsGarages, 
                      c(summary_modGaragesac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
  ...
  dataset %<>% add_column(ac_mail = ac_mail)
  # Run model
  modMail_ac <- lm(log(DistToMail+1) ~ Category_rare + ac_mail, data = dataset)
  # plotresid(modRail_ac)
  summary_modMailac <- summary(modMail_ac)
  ModelsMail <- rbind(ModelsMail, 
                     c(summary_modMailac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
  ...
  dataset %<>% add_column(ac_wood = ac_wood)
  # Run model
  modWood_ac <- lm(log(DistToWood+1) ~ Category_rare + ac_wood, data = dataset)
  # plotresid(modRail_ac)
  summary_modWoodac <- summary(modWood_ac)
  ModelsWood <- rbind(ModelsWood, 
                     c(summary_modWoodac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
  ...
  dataset %<>% add_column(ac_wineries = ac_wineries)
  # Run model
  modWineries_ac <- lm(log(DistToWineries+1) ~ Category_rare + ac_wineries, data = dataset)
  # plotresid(modRail_ac)
  summary_modWineriesac <- summary(modWineries_ac)
  ModelsWineries <- rbind(ModelsWineries, 
                     c(summary_modWineriesac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
  ...
  dataset %<>% add_column(ac_hobbies = ac_hobbies)
  # Run model
  modHobbies_ac <- lm(log(DistToHobbies+1) ~ Category_rare + ac_hobbies, data = dataset)
  # plotresid(modRail_ac)
  summary_modHobbiesac <- summary(modHobbies_ac)
  ModelsHobbies <- rbind(ModelsHobbies, 
                     c(summary_modHobbiesac$coefficients[c(1:4, 13:16)],  #for pos only, use 1:3, 10:12 
...
names(ModelsAirports) = c("Int_est", "DJ_est", "DN_est", 
                      ...
                      "Intp", "DJp", "DNp", 
                      "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsAirports, file.path(here(), "tables", "ModelsAirports_rarefied.csv"), row.names = F)
...
names(ModelsGarages) = c("Int_est", "DJ_est", "DN_est", 
                      ...
                      "Intp", "DJp", "DNp", 
                      "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsGarages, file.path(here(), "tables", "ModelsGarages_rarefied.csv"), row.names = F)
...
names(ModelsMail) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsMail, file.path(here(), "tables", "ModelsMail_rarefied.csv"), row.names = F)
...
names(ModelsWood) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsWood, file.path(here(), "tables", "ModelsWood_rarefied.csv"), row.names = F)
...
names(ModelsWineries) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsWineries, file.path(here(), "tables", "ModelsWineries_rarefied.csv"), row.names = F)
...
names(ModelsHobbies) = c("Int_est", "DJ_est", "DN_est", 
                     "AC_est",
                      "Intp", "DJp", "DNp", 
                     "ACp", "Rsquared", "Adj Rsquared")
write.csv(ModelsHobbies, file.path(here(), "tables", "ModelsHobbies_rarefied.csv"), row.names = F)
...
```{r visualize full DistToRail data}
ModelsAirports <- read.csv(file.path(here(), "tables",  "ModelsAirports_rarefied.csv"))
...
ModelsGarages <- read.csv(file.path(here(), "tables",  "ModelsGarages_rarefied.csv"))
...
ModelsMail <- read.csv(file.path(here(), "tables",  "ModelsMail_rarefied.csv"))
...
ModelsWood <- read.csv(file.path(here(), "tables",  "ModelsWood_rarefied.csv"))
...
ModelsWineries <- read.csv(file.path(here(), "tables",  "ModelsWineries_rarefied.csv"))
...
ModelsHobbies <- read.csv(file.path(here(), "tables",  "ModelsHobbies_rarefied.csv"))

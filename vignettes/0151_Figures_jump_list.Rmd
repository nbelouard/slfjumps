...
ggsave(file.path(here(), "figures", "manuscript figures", "3. jumps_map_v2.jpg"), map_rarified, height = 8, width = 8)
```
...
ggsave(file.path(here(), "figures", "manuscript figures", "3. number of jumps_v2.jpg"), jumps_plot, height = 2.5, width = 4)
```
...
ggsave(file.path(here(), "figures", "manuscript figures", "3. jump description_v2.jpg"), fig2, height = 10, width = 10)
